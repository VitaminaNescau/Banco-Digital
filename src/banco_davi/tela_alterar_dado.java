...
public class tela_alterar_dado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BT_enviar_sudo = new MyButton();
        SUDO_voltar_alt_dados = new MyButton();
    ...
    private void BT_enviar_sudoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_enviar_sudoActionPerformed
        ...
        String nome = SUDO_nome.getText();
        String cpf = SUDO_CPF.getText();
        String senha = SUDO_senha.getText();
        String senha6 = SUDO_senha6digitos.getText();
        String email = SUDO_email.getText();
        String pix = SUDO_PIX.getText();
        String tele= SUDO_telefone.getText();
        admACTION.trocaDado(cpf, cpf, nome, senha, senha6, pix, email,tele);
    ...
    private MyButton BT_enviar_sudo;
    ...
    private MyButton SUDO_voltar_alt_dados;
